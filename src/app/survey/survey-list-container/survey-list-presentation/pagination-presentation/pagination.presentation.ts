...
import { Pages } from '../../../../shared/modals/shared-model';
...
export class SurveyPaginationPresentation implements OnInit {
  ...
  public emitPaginationEvent(): void {
    ...
    this.presenter.surveyChunks(this.firstPageIndex - 1, this.lastPageIndex);
  }
